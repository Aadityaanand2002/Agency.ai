...
<div
  className='
    bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 
...
>
  ...
  />
    ...
    <div className='text-gray-600 dark:text-gray-400'>
      ...
      <p className='text-sm mt-2 mb-6'>This latest news, articlles, and 
  ...
  <input
    ...
    className='
      w-full p-3 text-sm outline-none rounded 
...
<div
  className='
    pb-6 text-sm text-gray-500 flex 
