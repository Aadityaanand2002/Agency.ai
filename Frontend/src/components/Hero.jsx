...
className='relative'>
<img src={assets.hero_img} alt="hero" className='w-full max-w-6xl mx-auto' />
<img src={assets.bgImage1} alt="decorative background" className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden' />
</motion.div>
